            ...
            module Init
                ...
                class InitRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def post(body, request_configuration=nil)
                        ...
                        return @request_adapter.send_async(request_info, lambda {|pn| RixlSdk::Models::Internal_images_handlerInitResponse.create_from_discriminator_value(pn) }, error_mapping)
                    end
                    ## 
                    ## Initialize a presigned URL upload for an image file using API key authentication
                    ## @param body The request body
